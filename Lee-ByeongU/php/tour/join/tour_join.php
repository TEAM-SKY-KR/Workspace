            ...
            <div class="p-3">
                ...
                <form action="" name="user_register_form">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="number"name="number" placeholder="전화번호" aria-label="number"
                               data-sb-validations="required">
                        <div class="invalid-feedback" data-sb-feedback="number:required">전화번호를 입력해주세요.</div>
                    </div>
                    <!--이메일-->
                    <div class="input-group mb-3">
