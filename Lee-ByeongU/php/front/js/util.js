...
let canvas, ctx;
let renderer, stage;
let sw = document.getElementById("logo_box").clientWidth;
let sh = document.getElementById("logo_box").clientHeight;

function generateCanvas() {
    canvas = document.createElement('canvas');
    document.getElementById("logo_box").appendChild(canvas);
...
function canvasResize() {
    sw = document.getElementById("logo_box").clientWidth;
    sh = document.getElementById("logo_box").clientHeight;
...
function generatePixi(bgcolor) {
    ...
    document.getElementById("logo_box").appendChild(renderer.view);
