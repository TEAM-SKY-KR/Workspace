    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto fs-5 fw-normal">  <!-- ms-auto: 오른쪽 정렬 / fs-5: 글씨 크기 -->
                <li class="nav-item py-2 px-2"><a class="nav-link py-3 rounded text-light" href="http://localhost/front">
                ...
                <li class="nav-item py-2 px-2">
                    <a class="nav-link py-3 text-light" href="#" onclick="window.open('stamp/stamp.php', 'z','width=500, height=500'); return false">
