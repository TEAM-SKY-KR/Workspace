        ...
        <div class="col-12 mt-2">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item"><a class="page-link" href="http://localhost/user/tourlist/tourlist.php?page=1">1</a></li>
                    <li class="page-item"><a class="page-link" href="http://localhost/user/tourlist/tourlist.php?page=2">2</a></li>
