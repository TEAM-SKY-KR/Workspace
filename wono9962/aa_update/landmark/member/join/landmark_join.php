...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-5 mx-auto">
            ...
            <div class="p-3">
                <!--아이디-->
                <form action="" name="landmark_register_form">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" style="width: 42px;"><i class="fas fa-key"></i></span>
                        <input type="password" class="form-control rounded-end" id="pw2" name="pw2" placeholder="비밀번호 확인"
                               data-sb-validations="required"/>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control rounded-end" id="email" name="email" placeholder="이메일"
                               aria-label="pw"
                               data-sb-validations="required">
                    ...
                    <!--담당자 휴대폰 번호-->
                    <div class="input-group mb-3">
                        <span class="input-group-text" style="width: 42px;"><i class="fas fa-phone-alt"></i></span>
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="담당자 휴대폰 번호(-없이 입력)" aria-label="phone"
                               data-sb-validations="required">
                        <div class="invalid-feedback" data-sb-feedback="phone:required">담당자 휴대폰 번호를 입력해주세요.</div>
                    </div>
                ...
                <div class="mt-3 text-center">
                    <span class="fs-6"><a class="fw-bold" href="../login/landmark_login.php" style="text-decoration: none">이미 회원이신가요?</a></span>
